...
const result = typeof convertToString(true) 
...
*/
const sizeReturnString = string => string.length

const resultado = sizeReturnString("CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO") 
...
*/
const stringToLowCase = string => string.toLowerCase()

const stringToLowerCase = stringToLowCase("CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO")
...
*/
const getIndex = ( charater , string ) => string.indexOf(charater)

console.log(getIndex('J', "CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO"))
/*
  05
...
*/
  ...
  console.log(isItemIncluded('b', ['v', 'e', 'p']))
/*
  06
...
*/
const concatArrays = (arrayOne, arrayTwo) => arrayOne.concat(arrayTwo)

console.log(concatArrays([1, 2, 3], ['v', 'e', 'p']))
/*
  07
...
console.log(arrayPop([5, 4, 3, 2, 1]))
/*
  08
  ...
  - Crie uma função que retorna se o valor passado como argumento em sua  
    invocação é null.
*/
const returNull = (parameter) => parameter === null

console.log(returNull(null))
/*
  09
...
// }
const newLetters = (item => {
  lettersCopy.push(item)
})

letters.forEach(newLetters)
...
const createParagraph = paragraph => {
  paragraphs += `<p style="color: deeppink;">${paragraph}</p>`
}
...
console.log(getLinkesMessage(['Renar', 'Freitas', 'dos', 'Santos', 'Sasaque']))
